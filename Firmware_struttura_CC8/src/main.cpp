...
void setup() {
  ...
  //front
  wheel_FL = Wheel(DRV_F_L_F, DRV_F_L_B);
  wheel_FR = Wheel(DRV_F_R_F, DRV_F_R_B);

  //rear
  wheel_RL = Wheel(DRV_R_L_F, DRV_R_L_B);
  wheel_RR = Wheel(DRV_R_R_F, DRV_R_R_B);

  //middle
  wheel_ML = Wheel(DRV_M_L_F, DRV_M_L_B);
  wheel_MR = Wheel(DRV_M_R_F, DRV_M_R_B);


  //Steering wheels
  steering_FL = SteeringWheel(STEER_F_L_S, STEER_F_L_D);
  steering_FR = SteeringWheel(STEER_F_R_S, STEER_F_R_D);
  steering_RL = SteeringWheel(STEER_R_L_S, STEER_R_L_D);
  steering_RR = SteeringWheel(STEER_R_R_S, STEER_R_R_D);
